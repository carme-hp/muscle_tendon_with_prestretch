...
for k in range(nz):
  for j in range(ny):
    for i in range(nx):
      initial_displacements[k*nx*ny + j*nx + i] = [0.0, 0.0,  a*k/(nz-1) ]
...
config = {
  ...
  "MappingsBetweenMeshes": {"muscle2_fiber{}".format(f) : ["muscle2Mesh", "muscle2Mesh_quadratic"] for f in range(variables.n_fibers_total)},
  "Solvers": {
    ...
    "Coupling": {
                ...
                "StrangSplitting": {
                      ...
                      "instances": [
                        {
                          ...
                          "Heun" : {
                            ...
                            "CellML" : {
                              ...
                              "setSpecificStatesCallEnableBegin":       variables.end_time, #get_specific_states_call_enable_begin(fiber_no, motor_unit_no),# [ms] first time when to call setSpecificStates
                              ...
                              "stimulationLogFilename":                 "out/" + variables.case_name + "/" + variables.scenario_name + "/stimulation_muscle2.log",                          # a file that will contain the times of stimulations
                            },
                            "OutputWriter" : [
                              {"format": "Paraview", "outputInterval": 1, "filename": "out/" + variables.case_name + "/" + variables.scenario_name + "/muscle2_0D_states({},{})".format(fiber_in_subdomain_coordinate_x,fiber_in_subdomain_coordinate_y), "binary": True, "fixedFormat": False, "combineFiles": True}
                  ...
                  "Term2": {
                    "MultipleInstances": {
                      ...
                      "OutputWriter" : [
                        {"format": "Paraview", "outputInterval": 1, "filename": "out/" + variables.case_name + "/" + variables.scenario_name + "/muscle2_fibers", "binary": True, "fixedFormat": False, "onlyNodalValues":True, "combineFiles": True, "fileNumbering": "incremental"},
                      ],
                    },
                  },
                }
      ...
      "Term2": {
        "MuscleContractionSolver": {
              ...
              "OutputWriter" : [
                {"format": "Paraview", "outputInterval": 1, "filename": "out/" + variables.case_name + "/" + variables.scenario_name + "/muscle2_contraction", "binary": True, "fixedFormat": False, "onlyNodalValues":True, "combineFiles": True, "fileNumbering": "incremental"},
              ],
              ...
              "DynamicHyperelasticitySolver": {
                ...
                "residualNormLogFilename":    "out/"+variables.case_name + "/" + variables.scenario_name+"/muscle2_log_residual_norm.txt",   # log file where residual norm values of the nonlinear solver will be written
                ...
                "dirichletOutputFilename":     "out/"+variables.case_name + "/" + variables.scenario_name+"/muscle2_dirichlet_boundary_conditions",     # output filename for the dirichlet boundary conditions, set to "" to have no output
                "totalForceLogFilename":       "out/"+variables.case_name + "/" + variables.scenario_name+"/muscle2_tendon_force.csv",              # filename of a log file that will contain the total (bearing) forces and moments at the top and bottom of the volume
                "totalForceLogOutputInterval":       1,                                  # output interval when to write the totalForceLog file

                # define which file formats should be written
                # 1. main output writer that writes output files using the quadratic elements function space. Writes displacements, velocities and PK2 stresses.
                "OutputWriter" : [
                  {"format": "Paraview", "outputInterval": 1, "filename": "out/"+variables.case_name + "/" + variables.scenario_name+"/muscle2_displacements", "binary": True, "fixedFormat": False, "onlyNodalValues":True, "combineFiles":True, "fileNumbering": "incremental"},
                ...
                "pressure": {   # output files for pressure function space (linear elements), contains pressure values, as well as displacements and velocities
                  "OutputWriter" : [
                    {"format": "Paraview", "outputInterval": 1, "filename": "out/"+variables.case_name + "/" + variables.scenario_name+"/muscle2_pressure", "binary": True, "fixedFormat": False, "onlyNodalValues":True, "combineFiles":True, "fileNumbering": "incremental"},
                  ]
                },
                # 3. additional output writer that writes virtual work terms
                "dynamic": {    # output of the dynamic solver, has additional virtual work values
                  "OutputWriter" : [   # output files for displacements function space (quadratic elements)
                    {"format": "Paraview", "outputInterval": 1, "filename": "out/"+variables.case_name + "/" + variables.scenario_name+"/muscle2_dynamic", "binary": True, "fixedFormat": False, "onlyNodalValues":True, "combineFiles":True, "fileNumbering": "incremental"},
                    {"format": "Paraview", "outputInterval": 1, "filename": "out/"+variables.case_name + "/" + variables.scenario_name+"/muscle2_virtual_work", "binary": True, "fixedFormat": False, "onlyNodalValues":True, "combineFiles":True, "fileNumbering": "incremental"},
                  ],
                },
                # 4. output writer for debugging, outputs files after each load increment, the geometry is not changed but u and v are written
                "LoadIncrements": {
                  "OutputWriter" : [
                    #{"format": "Paraview", "outputInterval": 1, "filename": "out/"+variables.scenario_name+"/muscle2_load_increments", "binary": True, "fixedFormat": False, "onlyNodalValues":True, "combineFiles":True, "fileNumbering": "incremental"},
                  ]
                }  
              }   
          # }
